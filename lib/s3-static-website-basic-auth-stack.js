...
class S3StaticWebsiteBasicAuthStack extends Stack {
  ...
  constructor(scope, id, props) {
    ...
    const crossOriginIsolationHeadersPolicy = new cloudfront.ResponseHeadersPolicy(this, 'ResponseHeadersPolicy', {
      responseHeadersPolicyName: 'crossOriginIsolationPolicy',
    ...
    const cfDistribution = new cloudfront.Distribution(this, 'Distribution', {
      ...
      defaultBehavior: {
        ...
        responseHeadersPolicy: crossOriginIsolationHeadersPolicy,
        edgeLambdas: [
          {
